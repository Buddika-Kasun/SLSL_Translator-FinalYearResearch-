  ...
  const phases = [
    {
      ...
      color: "blue",
      items: [
        "50 medical sentences × 3 signers × 2 reps = 100+ videos",
        "MediaPipe Holistic extracts 468 landmarks per frame",
        "280 frames per video (3 seconds at 30fps)",
        "Total: 131,040 features per video",
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        "280-frame buffer for continuous signing",
            ...
            <div className="relative mt-12">
              ...
              <div className="flex items-center justify-between gap-4 mb-4">
                ...
                >
                  ...
                  <div className="text-[8px] text-orange-500/70">280 frames</div>
                </motion.div>
              </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-xs text-muted-foreground mb-3">
                  Concatenate all streams (468 features)
                </p>
        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-6">
            ...
            <p className="text-sm text-muted-foreground">
              468 landmarks per frame • 280 frames per video • 131,040 features
              total
            </p>
          </motion.div>
