...
export function Results() {
  ...
  const classPerformance = [
    ...
    { class: "Class 28", accuracy: 90, samples: 2, color: "green" },
    { class: "Class 5", accuracy: 85, samples: 1, color: "green" },
    { class: "Class 7", accuracy: 83, samples: 1, color: "green" },
    { class: "Class 6", accuracy: 67, samples: 2, color: "yellow" },
    { class: "Class 14", accuracy: 33, samples: 1, color: "red" },
  ];
  ...
  const datasetStats = [
    { label: "Total Videos", value: "150+", sub: "successfully loaded" },
    { label: "Classes", value: "50", sub: "medical sentences" },
    { label: "Train/Val/Test", value: "80/84/86", sub: "samples" },
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    overfitting. With 1000+ samples, we project 80-90% accuracy.
                  </p>
                </div>
              </div>
            </motion.div>
